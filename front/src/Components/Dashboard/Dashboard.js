        ...
        <div className="stats-con">
          ...
          <div className="history-con">
            ...
            <div className="salary-item">
              <p>Rs {Math.min(...filteredIncomes.map((item) => item.amount))}</p>
              <p>Rs {Math.max(...filteredIncomes.map((item) => item.amount))}</p>
            </div>
            <h2 className="salary-title">
              Min <span>Expense</span> Max
            </h2>
            <div className="salary-item">
              <p>Rs {Math.min(...filteredExpenses.map((item) => item.amount))}</p>
              <p>Rs {Math.max(...filteredExpenses.map((item) => item.amount))}</p>
            </div>
          </div>
        </div>
      </InnerLayout>
